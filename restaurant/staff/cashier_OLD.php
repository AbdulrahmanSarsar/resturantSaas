...
if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['ajax'])) {
    ...
    // تحقق إن الطلب تبع هالمطعم ومسلّم
...
<div class="topbar">
    ...
    <div class="topbar-btns">
        ...
        <a href="login.php" class="icon-btn logout" title="خروج">
