    ...
    <style>
        ...
        *::after {
        ...
        .ocard.st-ready {
            ...
            animation: cardIn .35s cubic-bezier(.22, 1, .36, 1) both, readyCardPulse 2.5s infinite;
        }

        .ocard.st-ready::after {
            background: #22C55E;
        }

        .ocard.st-confirmed::after {
            background: #3B82F6;
        }

        .ocard.st-preparing::after {
            background: #8B5CF6;
        }

        .ocard.st-pending::after {
            background: #F59E0B;
        }
...
<body>
    ...
    <div class="content">
        ...
        <div class="live-bar">
            <div class="live-dot"></div> يتجدد تلقائياً
        </div>
    ...
    <script>
        ...
        ['click', 'touchstart', 'keydown'].forEach(ev =>
            document.addEventListener(ev, () => {
                ...
                if (sessionStorage.getItem('pendingBeep')) {
                    sessionStorage.removeItem('pendingBeep');
                    setTimeout(() => _beep('ready'), 100);
                }
            }, {
                passive: true
            })
