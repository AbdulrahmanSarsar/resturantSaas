 ...
 *
 * الباقات (محدّثة 26 أبريل 2026):
 *   basic    $15/شهر  — منيو + QR + ألوان/شعار + فرع واحد + دعم 24h
 *   advanced $20/شهر  — + AR + تقييمات + إحصائيات + تقارير + مقارنة فروع + خطوط متقدمة
 *   premium  $25/شهر  — + طلبات + موظفين + كوبونات + شام كاش + فروع متعددة + مدير حساب
 */
...
if (!defined('PLAN_FEATURES')) {
    define('PLAN_FEATURES', [
        ...
        'premium' => [
            ...
            'advanced_fonts',
            'priority_support',
            'orders',            // نظام طلبات لحظي
            'staff',             // كاشير + مطبخ + نادل + إدارة موظفين
            'coupons',           // كوبونات
            'offers',            // عروض BxGy / كومبو
            'shamcash',          // شام كاش
            'multi_branch',      // فروع متعددة (غير محدود)
            'account_manager',
        ],
    ]);
}
