...
.login-card::before {
    ...
    height: 2px; background: var(--p); border-radius: 24px 24px 0 0;
}
@keyframes popIn {
...
.brand {
    ...
    margin-bottom: 28px;
    animation: fadeUp 0.5s cubic-bezier(0.22,1,0.36,1) .1s both;
}
.brand-mark {
    width: 42px; height: 42px; border-radius: 13px;
    background: var(--p); display: flex; align-items: center; justify-content: center;
    box-shadow: 0 4px 16px rgba(255,107,53,0.4); flex-shrink: 0;
}
.brand-mark svg { width: 20px; height: 20px; color: #fff; }
.brand-right {}
.brand-name {
    font-family: 'Fraunces', serif;
    font-size: 17px; font-weight: 900; color: var(--ink); line-height: 1;
}
...
.brand-divider {
    ...
    margin-bottom: 24px;
    animation: fadeUp 0.5s cubic-bezier(0.22,1,0.36,1) .14s both;
}

/* Heading */
.login-heading {
    margin-bottom: 22px;
    animation: fadeUp 0.5s cubic-bezier(0.22,1,0.36,1) .18s both;
}
.login-title {
    font-family: 'Fraunces', serif;
    font-size: 26px; font-weight: 900; color: var(--ink); line-height: 1.1;
    margin-bottom: 5px;
}
...
.fg:nth-child(1){animation-delay:.22s}
.fg:nth-child(2){animation-delay:.28s}

.fg label {
    display: block; font-size: 10px; font-weight: 700;
    color: var(--ink2); letter-spacing: 1.5px; text-transform: uppercase;
    margin-bottom: 8px;
}
...
.eye-btn {
    ...
    color: var(--ink2); padding: 3px; transition: color 0.2s; display: flex;
}
...
.security-note {
    ...
    margin-top: 20px; font-size: 11px; color: var(--ink2);
    animation: fadeUp 0.5s cubic-bezier(0.22,1,0.36,1) .4s both;
}
